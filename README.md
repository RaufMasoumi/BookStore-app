...
The project was deployed to Heroku and you can check it now at rauf-book-store-app.herokuapp.com (For the best experience please add this site to your browser's trusted sites list).
...
The base and non-dynamic template or actual front-end is from KeenThemes.com.
## Features
